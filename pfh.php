...
<html> 
  ...
  <body class="projects">
    ...
    <div class="col-md-12">
      ...
      <div id="pfh" class="col-md-12">
        <img src="img/etiquettes/pfh.jpg" class="col-md-1" style="width:8%"></img>
        <div class="col-md-11">
          <br/>
          <br/>
          <video width="720" height="405" controls>
              <source src="http://creatinox.free.fr/MI_PFH.mov" type="video/mp4">
              Your browser does not support the video tag.
          </video>
          <br/>
          <span style="font-size:13px; margin-top:20px !important">Marie DAGNIAU - Paul-Henri GUENARD - Nicolas HEC - Jérôme MERLE - Naoki MIYASHITA - Tino NGUYEN - Gloria TONDABO</span>
          <br/>
          <br/>
        </div>
      </div> 
