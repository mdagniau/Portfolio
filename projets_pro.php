  ...
  <body class="projects">
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-3 "><h1>EIAD</h1><h5><b>Entretiens Individuels Appréciations & Développement</b></h5>  
        ...
        Tout ça pour automatiser la saisie des Entretiens individuels Annuels afin qu’ils soient pérennes.</p>
        <br/>
      ...
      <div class="col-md-3 "><h1>Manage-TV</h1>      
        <br/>
        <br/>
        <p>PHP et scripts bash sont nécessaires pour automatiser la mise à jour des données (CA, TJ, nombre d’intercontrats…) affichées sur une télévision. </p>
        <br/><br/>
      ...
      <div class="col-md-3 "><h1>Intranet Vision</h1>      
        ...
        <br/>
        <br/>
        <p>Utilisation du CMS Liferay, maintenance, création de nouvelles fonctionnalités…</p>
        <br/><br/><br/><br/><br/>
