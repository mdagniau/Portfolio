    ...
    <div class="col-md-12">
      ...
      <div class="col-md-9 presentation">
        <div id="bio" class="bio col-md-12">
          <img src="img/etiquettes/projects.png" class="col-md-1" style="width:8%"></img>
          <div class="col-md-11 bio">
            ...
            <div class="csslider1 no-autoplay bio">
              ...
              <ul class="bio">
                <li class="cs_skeleton bio"><img src="img/slider/eiad_en.jpg" class="bio"></li>
                <li class="num0 img slide bio"> <img src="img/slider/eiad_en.jpg" alt="" title=""></li>
                <li class="num1 img slide bio"> <img src="img/slider/manage-tv_en.jpg" alt="" title=""></li>
                <li class="num2 img slide bio"> <img src="img/slider/intranet_en.jpg" alt="" title=""></li>
              </ul>    
