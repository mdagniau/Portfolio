    ...
    <div class="col-md-12">
      ...
      <div class="col-md-9 presentation">
        <div id="bio" class="bio col-md-12">
          <img src="img/etiquettes/cv video.png" class="col-md-1" style="width:8%"></img>
          <div class="col-md-11 bio">
            <br/><i style="text-align:center">Cette vidéo a été réalisée dans le cadre d'un travail scolaire lors de ma seconde année en école d'ingénieur.<br/> Vous pouvez trouver mon CV complet en version papier dans la partie <a href="contact.php">Contact</a>. </i>
