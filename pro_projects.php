...
<html> 
  ...
  <body class="projects">
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-11">
      <div class="col-md-3 "><h1>EIAD</h1><h5><b>'Entretiens Individuels Appréciations & Développement'</b></h5>  
        <br/>
        <br/>
        <p>JAVA, JEE, Primefaces, Hibernate, MySQL
        All this to automate the capture of Annual Individual interviews so that they are sustainable.</p>
        <br/>
        <img src="img/logos/logo_java.png" style="width:85%"/><br/>
        <br/>
      </div>
      <div class="col-md-1"></div>
      <div class="col-md-3 "><h1>Manage-TV</h1>      
        <br/>
        <br/>
        <br/>
        <p>PHP and bash scripts are needed to automate the updating of data ( CA , TJ, number intercontract ... ) displayed on a TV. </p>
        <br/><br/>
        <img src="img/logos/logo-php.png" style="width:85%"/><br/>
        <br/>
      </div>
      <div class="col-md-1"></div>
       <div class="col-md-3 "><h1>Intranet Vision</h1>      
        <br/>
        <br/>
        <br/>
        <p>Using Liferay CMS , maintenance, creation of new features ...</p>
        <br/><br/><br/><br/><br/>
        <img src="img/logos/logo liferay.png" style="width:85%"/><br/>
        <br/>
      </div>
    </div>
      <a href="projects_detailled.php" style="text-align:center;">Do you want to know more ?</a> 
      <br/>
      <br/> 
  </div>
  </div>
