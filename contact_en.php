  ...
  <body class="projects">
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-4">        
        ...
        <br/>
        <div class="col-md-12">
        <img onclick="cv()" src="img/logos/logo-CV.jpg" class="col-md-6 logo"></img>
         <script>function cv() {
            alert("To obtain my CV, please send me a mail. Thank you.");
        }
        </script>
        </div>
        <br/>
        ...
        <br/>
        <div class="col-md-12">
          <a href="https://www.visionitgroup.fr" target="_blank"><img src="img/logos/logo-vision.png" class="col-md-6 logo"></img></a>
        </div>
        <br/>
        <br/>
        <br/>
      ...
      <div class="col-md-4" style="text-align:left" >             
        ...
        <br/>
        <div class="col-md-12">
          <a href="https://fr.linkedin.com/pub/marie-dagniau/a9/92a/7bb" target="_blank"><img src="img/logos/logo-LinkedIn.png" class="col-md-6 logo"></img></a>
        </div>
        <br/>
        <br/>
        <br/>
        ...
        <div class="col-md-12" style="padding-left:15%">
          <span class="glyphicon glyphicon-envelope" style="font-family:sans-serif; text-align : left"> : mdagniau'at'visionitgroup.fr</span>
          <br/><br/>
          <span class="glyphicon glyphicon-envelope" style="font-family:sans-serif; text-align : left"> : dagniau'at'et.esiea.fr</span>
          <br/><br/>
          <span class="glyphicon glyphicon-envelope" style="font-family:sans-serif; text-align : left"> : m.dagniau'at'gmail.com</span>
        </div>
      </div>
      <div class="col-md-4">                  
        <br/>
        ...
        <br/>
         <div class="col-md-12">
           <a href="http://fr.viadeo.com/fr/profile/marie.dagniau" target="_blank"><img src="img/logos/logo-viadeo.png" class="col-md-6 logo"></img></a>
         </div>
        <br/>
        <br/>
        <br/>
        ...
        <br/>
         <div class="col-md-12">
           <a href="http://www.esiea.fr/" target="_blank"><img src="img/logos/logo-esiea.jpg" class="col-md-6 logo"></img></a>
         </div>
        <br/>
        <br/>
        <br/>
