...
<html> 
  ...
  <body class="projects">
    ...
    <div class="col-md-12">
      ...
      <br/>
      <br/>
      <div class="col-md-4 " ><h1>Encadrement de stagiaires</h1> 
        <br/>
        <br/>
        <br/>
        <p>Superviser leur travail, répondre aux questions, accompagner...</p>
        <br/>
        <br/> 
      ...
      <div class="col-md-3 "><h1>Animatrice & SGDF</h1> 
        <br/>
        <br/>
        <p>Partage, rires, encadrement, rencontres, apprentissage de la vie : cuisine, responsabilités…</p>
        <br/>
        <br/>
        <br/>
      ...
      <div class="col-md-1"></div>
       <div class="col-md-3"><h1>PFH</h1><h5><b>Projet de Formation Humaine</b></h5>      
        <br/>
        <p>Un ingénieur n’est pas que technique, il travaille aussi en équipe !
        Ecrire un scénario, trouver les accessoires, filmer & monter… tout ça ensemble ! :)</p><h6 style="font-size:11px; align:left">Partagez cette expérience en cliquant sur le logo</h6><br/>
        <a href="pfh.php"><img src="img/logos/MI.jpg" style="width:85%"/></a>
        <br/><br/>
      </div>
    </div> 
  </div>
