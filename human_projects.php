...
<html> 
  ...
  <body class="projects">
    ...
    <div class="col-md-12">
      ...
      <br/>
      <br/>
      <div class="col-md-4 " ><h1>Mentoring of interns</h1> 
        <br/>
        <br/>
        <br/>
        <p>Supervise their work; help them achieve their objectives, answer questions, etc.</p>
        <br/>
        <br/> 
        <img src="img/team.jpg" style="width:85%"/><br/>
        <br/>
      </div>
      <div class="col-md-1"></div>
      <div class="col-md-3 "><h1>Supervising the Boy Scout</h1> 
        <br/>
        <br/>
        <p>Sharing with them, having fun, teaching them life, responsibilities, cooking, etc.</p>
        <br/>
        <br/>
        <br/>
        <a href="http://www.sgdf.fr/" target="_blank"><img src="img/logos/logo-sgdf.jpg" style="width:85%"/></a>
        <br/>
        <br/>
        <br/>
      </div>
      <div class="col-md-1"></div>
       <div class="col-md-3"><h1>PFH</h1><h5><b>Projet de Formation Humaine</b></h5>      
        <br/>
        <p>Being an engineer isn’t just about technicality; we have to work together with other people!
          Writing a scenario, finding the right accessories, filming… All this as a team! :) </p>
          <h6 style="font-size:11px; align:left">Share this experience by clicking on the logo</h6><br/>
        <a href="pfh_en.php"><img src="img/logos/MI.jpg" style="width:85%"/></a>
        <br/><br/>
      </div>
    </div> 
  </div>
